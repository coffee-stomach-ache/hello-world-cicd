...
-- -----------------------------------------------------
-- Schema hirotatastylog
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `hirotatastylog` ;

-- -----------------------------------------------------
-- Schema hirotatastylog
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `hirotatastylog` DEFAULT CHARACTER SET utf8 ;
USE `hirotatastylog` ;

-- -----------------------------------------------------
-- Table `hirotatastylog`.`m_address`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `hirotatastylog`.`m_address` ;

CREATE TABLE IF NOT EXISTS `hirotatastylog`.`m_address` (
...
-- -----------------------------------------------------
-- Table `hirotatastylog`.`t_shop`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `hirotatastylog`.`t_shop` ;

CREATE TABLE IF NOT EXISTS `hirotatastylog`.`t_shop` (
...
-- -----------------------------------------------------
-- Table `hirotatastylog`.`t_user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `hirotatastylog`.`t_user` ;

CREATE TABLE IF NOT EXISTS `hirotatastylog`.`t_user` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `hirotatastylog`.`t_review`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `hirotatastylog`.`t_review` ;

CREATE TABLE IF NOT EXISTS `hirotatastylog`.`t_review` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `hirotatastylog`.`m_category`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `hirotatastylog`.`m_category` ;

CREATE TABLE IF NOT EXISTS `hirotatastylog`.`m_category` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `hirotatastylog`.`t_shop_category`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `hirotatastylog`.`t_shop_category` ;

CREATE TABLE IF NOT EXISTS `hirotatastylog`.`t_shop_category` (
  `shop_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `hirotatastylog`.`sessions`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `hirotatastylog`.`sessions` ;

CREATE TABLE IF NOT EXISTS `hirotatastylog`.`sessions` (
...
-- -----------------------------------------------------
-- Table `hirotatastylog`.`t_login_history`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `hirotatastylog`.`t_login_history` ;

CREATE TABLE IF NOT EXISTS `hirotatastylog`.`t_login_history` (
  `user_id` INT NOT NULL,
